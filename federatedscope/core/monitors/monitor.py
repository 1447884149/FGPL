...
class Monitor(object):
    ...
    def finish_fl(self):
        ...
        if self.cfg.show_detailed_communication_info:
    ...
    def get_sys_metrics(self, verbose=True):
        system_metrics = {
            ...
            "local_total_training_time_seconds": self.total_training_time,
            "local_total_inference_time_seconds": self.total_inference_time,
        }
        if verbose:
            logger.info(
    ...
    def track_training_time(self, training_time):
        assert isinstance(training_time, datetime.timedelta)
        self.total_training_time += training_time.total_seconds()

    def track_inference_time(self, inference_time):
        assert isinstance(inference_time, datetime.timedelta)
        self.total_inference_time += inference_time.total_seconds()
