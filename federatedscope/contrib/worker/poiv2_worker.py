...
class POIV2Client(Client):
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(POIV2Client, self).__init__(ID, server_id, state, config, data, model, device,
...
def call_my_worker(method):
    if method == 'poiv2':
        worker_builder = {'client': POIV2Client, 'server': POIV2Server}
        return worker_builder


register_worker('poiv2', call_my_worker)
