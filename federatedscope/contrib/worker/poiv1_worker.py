...
class POIV1Client(Client):
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(POIV1Client, self).__init__(ID, server_id, state, config, data, model, device,
        ...
        # For visualization of generated graph
        self.client_generated_graph = dict()
    ...
    def callback_funcs_for_model_para(self, message: Message):
        ...
        if self._cfg.vis_embedding:
            ...
            self.client_generated_graph[round] = self.trainer.ctx.new_data
    ...
    def callback_funcs_for_finish(self, message: Message):
        ...
        if self._cfg.vis_embedding:
            ...
            torch.save(self.client_generated_graph,f'{folderPath}/generated_data_on_client_{self.ID}.pth')
        self._monitor.finish_fl()

def call_my_worker(method):
    if method == 'poiv1':
        worker_builder = {'client': POIV1Client, 'server': POIV1Server}
        return worker_builder


register_worker('poiv1', call_my_worker)
