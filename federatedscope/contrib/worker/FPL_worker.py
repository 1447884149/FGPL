...
class FPLClient(Client):
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(FPLClient, self).__init__(ID, server_id, state, config, data, model, device,
...
def call_my_worker(method):
    if method == 'fpl':
        worker_builder = {'client': FPLClient, 'server': FPLServer}
        return worker_builder


register_worker('fpl', call_my_worker)
