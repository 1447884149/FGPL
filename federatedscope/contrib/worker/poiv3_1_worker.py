...
class POIV3_1_Client(Client):
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(POIV3_1_Client, self).__init__(ID, server_id, state, config, data, model, device,
...
def call_my_worker(method):
    if method == 'poiv3_1':
        worker_builder = {'client': POIV3_1_Client, 'server': POIV3_1_Server}
        return worker_builder


register_worker('poiv3_1', call_my_worker)
