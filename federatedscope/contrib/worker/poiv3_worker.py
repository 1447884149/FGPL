...
class POIV3Client(Client):
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(POIV3Client, self).__init__(ID, server_id, state, config, data, model, device,
...
def call_my_worker(method):
    if method == 'poiv3':
        worker_builder = {'client': POIV3Client, 'server': POIV3Server}
        return worker_builder


register_worker('poiv3', call_my_worker)
