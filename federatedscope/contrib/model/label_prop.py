...
class LabelPropagation(MessagePassing):
    ...
    @torch.no_grad()
    def forward(self,y,edge_index,train_mask):
        # for POI_V3
    ...
    def message(self, x_j: Tensor, edge_weight: OptTensor) -> Tensor:
        return x_j if edge_weight is None else edge_weight.view(-1, 1) * x_j #zhl:x_j用来索引edge_index中第0行（发送消息的节点的embeeding）
